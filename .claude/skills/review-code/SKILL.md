...
Canonical skill: **`.agent/skills/review-code/SKILL.md`**

This skill is the consolidated replacement for `code-review` and `critical-review`. See the canonical file for the full protocol.
